...
const PREFIX = joinpath(path_prefix("xxzpaper"), "low_density/run_$RUNNUMBER")
const GEOMETRY = :box_pbc
const DIM = 1
const ALPHA = 6
const N = parse(Int, ARGS[1])
const ρs = 1 ./ unique!([1.0:0.05:2; 2:0.15:3])
...
using Statistics
const AVG_PREFIX = joinpath(path_prefix("xxzpaper"), "low_density-avg/run_$RUNNUMBER")
